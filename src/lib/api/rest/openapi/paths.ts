...
import {
  ...
  PostBulkResultSchema,
  PostAnalyticsResultSchema,
  ConnectionDTOSchema,
...
export const restPaths = {
  ...
  "/api/v1/posts/bulk": {
    post: {
      ...
      responses: { "200": jsonResponse("Bulk result", PostBulkResultSchema), ...errorResponses },
    },
  },
  "/api/v1/posts/{id}": {
    get: {
  ...
  "/api/v1/posts/{id}/analytics": {
    get: {
      ...
      parameters: [pathParam("id", "Post UUID")],
      responses: { "200": jsonResponse("Post analytics", PostAnalyticsResultSchema), ...errorResponses },
    },
  },
  "/api/v1/connections": {
    get: {
  ...
  "/api/v1/connections/{id}/reauth": {
    post: {
      ...
      parameters: [pathParam("id", "Connection UUID")],
      responses: { "200": jsonResponse("Reauth URL", ConnectionReauthResultSchema), ...errorResponses },
    },
  },
  ...
  "/api/v1/media/upload-url": {
    post: {
      ...
      responses: { "200": jsonResponse("Signed upload URL", MediaUploadUrlSchema), ...errorResponses },
    },
  },
  "/api/v1/media/attach-from-url": {
    post: {
      ...
      responses: { "200": jsonResponse("Uploaded media info", MediaAttachResultSchema), ...errorResponses },
    },
  },
  "/api/v1/media/{path}": {
    get: {
      ...
      responses: { "200": jsonResponse("Signed view URL", MediaViewUrlSchema), ...errorResponses },
    },
    delete: {
      tags: ["Media"],
      ...
      responses: { "200": jsonResponse("Delete result", MediaDeleteResultSchema), ...errorResponses },
    },
  },
  "/api/v1/analytics": {
    get: {
  ...
  "/api/v1/webhooks": {
    post: {
      ...
      responses: { "201": jsonResponse("Created subscription (includes secret)", WebhookSubscriptionCreatedSchema), ...errorResponses },
    },
    get: {
      tags: ["Webhooks"],
      summary: "List webhook subscriptions",
      operationId: "listWebhooks",
      responses: { "200": jsonResponse("Subscriptions", WebhookSubscriptionListSchema), ...errorResponses },
    },
  },
  "/api/v1/webhooks/{id}": {
    get: {
    ...
    delete: {
      ...
      parameters: [pathParam("id", "Subscription UUID")],
      responses: { "200": jsonResponse("Deleted", WebhookDeleteResultSchema), ...errorResponses },
    },
  },
  "/api/v1/webhooks/{id}/test": {
    post: {
      ...
      responses: { "200": jsonResponse("Test delivery result", WebhookTestResultSchema), ...errorResponses },
    },
  },
  ...
  "/api/v1/webhooks/{id}/deliveries/{delivery_id}/replay": {
    post: {
      ...
      responses: { "200": jsonResponse("Replay result", WebhookReplayResultSchema), ...errorResponses },
    },
  },
