...
interface EyeTrackingProps {
  ...
  /** Optional element used to calculate pupil dilation proximity */
  dilationTargetRef?: React.RefObject<HTMLElement | null>;
  /** Eyelid visibility */
  showEyelids?: boolean;
}
...
function Eye({
  ...
  const irisRotation = useTransform(
    springX,
    [-maxOffset, maxOffset],
    [-15, 15],
  );
  ...
  const borderRadius =
    variant === "minimal" ? "50%" : variant === "cartoon" ? "50%" : "50%";
          ...
          style={{
            ...
            background:
              variant === "cyber"
                ...
                : pupilColor,
            boxShadow:
              variant === "cyber" ? `0 0 10px ${irisColor}88` : undefined,
          }}
          animate={{
