...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to http://localhost:3000/scheduled (protected route).
        await page.goto("http://localhost:3000/scheduled")
        
        # -> Fill Clerk sign-in form with test credentials and submit (email: test.ttesto@gmail.com, password: Lamala56@) so the Scheduled page can be accessed for verification.
