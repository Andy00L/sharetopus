...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /connections (http://localhost:3000/connections). After navigation, check for text 'Instagram' and ensure 'Connect' is not visible.
        await page.goto("http://localhost:3000/connections")
        
        # -> Fill the Clerk sign-in form and submit to authenticate so the /connections page can be inspected for 'Instagram' and 'Connect'.
