...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /connections (http://localhost:3000/connections) and then verify the URL contains '/connections' and the page shows 'Connections', 'TikTok', 'Pinterest', 'LinkedIn', and 'connected'.
        await page.goto("http://localhost:3000/connections")
        
        # -> Fill in the Clerk sign-in form with test credentials and click Continue to authenticate (then verify the Connections page after login).
        ...
        # -> Wait for the authentication redirect to complete, then navigate to http://localhost:3000/connections to verify the Connections page content.
        await page.goto("http://localhost:3000/connections")
